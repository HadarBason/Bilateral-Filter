package Dip.ConvolutionFunctions;
...
public class bilateralRGB {
    ...
    public static void main(String[] args) throws IOException {
        BufferedImage source = ImageIO.read(new File("C:\\Users\\hadar\\OneDrive\\שולחן העבודה\\אוניברסיטה\\סמסטר ה\\mini bio\\bilateral\\src\\rubiks_cube.png"));
